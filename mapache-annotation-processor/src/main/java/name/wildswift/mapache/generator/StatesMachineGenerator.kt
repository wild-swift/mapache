...
//        processingEnv.filer.createSourceFile()
    ...
    private fun generateStateMachine(prefix: String, configName: String, type: ConfigType) {
        ...
        TransitionsWrapperGenerator(generationModel.transitionsBasePackage, generationModel.baseTransitionClass, generationModel.emptyTransitionClass, generationModel.baseEventClass, generationModel.baseStateWrappersClass, generationModel.dependencySource, generationModel.transitions, processingEnv).generateAll()
